...
extern "C" IMPEXP uint8
clip8(int32 c);
extern "C" IMPEXP rgb_color
highcolor(void);
extern "C" IMPEXP rgb_color
lowcolor(void);
extern "C" IMPEXP int32
currentmode(void);
extern "C" IMPEXP rgb_color
...
extern "C" IMPEXP pattern
currentpattern(void);
extern "C" IMPEXP bgra_pixel
weighted_average(bgra_pixel a, uint8 wa, bgra_pixel b, uint8 wb);
extern "C" IMPEXP bgra_pixel
weighted_average_rgb(rgb_color a, uint8 wa, rgb_color b, uint8 wb);
extern "C" IMPEXP int
Scale(BBitmap* src, BBitmap* srcmap, BBitmap* dest, BBitmap* destmap);
extern "C" IMPEXP void
AddWithAlpha(BBitmap* src, BBitmap* dest, long x, long y, int strength = 255);
extern "C" IMPEXP void
BlendWithAlpha(BBitmap* src, BBitmap* dest, long x, long y, int strength = 255);
extern "C" IMPEXP void
CutOrCopy(BBitmap* src, BBitmap* dest, BBitmap* selection, long offx, long offy, bool cut);
extern "C" IMPEXP BBitmap*
entry2bitmap(BEntry entry, bool silent = false);
extern "C" IMPEXP rgb_color
hsv2rgb(hsv_color c);
extern "C" IMPEXP rgb_color
...
extern "C" IMPEXP bgra_pixel
cmyk2bgra(cmyk_pixel c);
extern "C" IMPEXP bgra_pixel
rgb2bgra(rgb_color c);
extern "C" IMPEXP bgra_pixel
hsv2bgra(hsv_color c);
extern "C" IMPEXP cmyk_pixel
bgra2cmyk(bgra_pixel c);
extern "C" IMPEXP cmyk_pixel
rgb2cmyk(rgb_color c);
extern "C" IMPEXP cmyk_pixel
hsv2cmyk(hsv_color c);
extern "C" IMPEXP float
diff(rgb_color a, rgb_color b);
extern "C" IMPEXP uchar
clipchar(float x);
extern "C" IMPEXP float
clipone(float x);
extern "C" IMPEXP float
