...
bgra_pixel average6 (bgra_pixel a, bgra_pixel b, bgra_pixel c, bgra_pixel d, bgra_pixel e, bgra_pixel f)
{
//  This is valid for both IA and PPC
	bgra_pixel r = (((a >> 24) + (b >> 24) + (c >> 24) + (d >> 24) + (e >> 24) + (f >> 24))/6) << 24;
	r += ((a & 0x00FF0000) + (b & 0x00FF0000) + (c & 0x00FF0000) + (d & 0x00FF0000) + (e & 0x00FF0000) + (f & 0x00FF0000))/6;
	r &= 0xFFFF0000;
	r += ((a & 0x0000FF00) + (b & 0x0000FF00) + (c & 0x0000FF00) + (d & 0x0000FF00) + (e & 0x0000FF00) + (f & 0x0000FF00))/6;
	r &= 0xFFFFFF00;
	r += ((a & 0x000000FF) + (b & 0x000000FF) + (c & 0x000000FF) + (d & 0x000000FF) + (e & 0x000000FF) + (f & 0x000000FF))/6;
	return (r);
}

bgra_pixel average9 (bgra_pixel a, bgra_pixel b, bgra_pixel c, bgra_pixel d, bgra_pixel e, bgra_pixel f, bgra_pixel g, bgra_pixel h, bgra_pixel i)
{
//  This is valid for both IA and PPC
	bgra_pixel r = (((a >> 24) + (b >> 24) + (c >> 24) + (d >> 24) + (e >> 24) + (f >> 24) + (g >> 24) + (h >> 24) + (i >> 24))/9) << 24;
	r += ((a & 0x00FF0000) + (b & 0x00FF0000) + (c & 0x00FF0000) + (d & 0x00FF0000) + (e & 0x00FF0000) + (f & 0x00FF0000) + (g & 0x00FF0000) + (h & 0x00FF0000) + (i & 0x00FF0000))/9;
	r &= 0xFFFF0000;
	r += ((a & 0x0000FF00) + (b & 0x0000FF00) + (c & 0x0000FF00) + (d & 0x0000FF00) + (e & 0x0000FF00) + (f & 0x0000FF00) + (g & 0x0000FF00) + (h & 0x0000FF00) + (i & 0x0000FF00))/9;
	r &= 0xFFFFFF00;
	r += ((a & 0x000000FF) + (b & 0x000000FF) + (c & 0x000000FF) + (d & 0x000000FF) + (e & 0x000000FF) + (f & 0x000000FF) + (g & 0x000000FF) + (h & 0x000000FF) + (i & 0x000000FF))/9;
	return (r);
}
...
bgra_pixel weighted_average_rgb (rgb_color ca, uint8 wa, rgb_color cb, uint8 wb)
{
#if defined (__POWERPC__)
