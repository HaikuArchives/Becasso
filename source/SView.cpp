...
void SView::GetPosition (Position *position, bool setcursor)
{
	// clock_t start, end;
	// start = clock();
	BPoint point;
...
inline void SView::StrokeRect (BRect r, pattern p)
{
	inherited::StrokeRect (makePositive (r), p);
}

inline void SView::FillRect (BRect r, pattern p)
{
	inherited::FillRect (makePositive (r), p);
}

inline void SView::InvertRect (BRect r)
{
	inherited::InvertRect (makePositive (r));
}

inline void SView::StrokeRoundRect (BRect r, float xRadius, float yRadius, pattern p)
{
	inherited::StrokeRoundRect (makePositive (r), xRadius, yRadius, p);
}

inline void SView::FillRoundRect (BRect r, float xRadius, float yRadius, pattern p)
{
	inherited::FillRoundRect (makePositive (r), xRadius, yRadius, p);
}

inline void SView::StrokeEllipse (BRect r, pattern p)
{
	inherited::StrokeEllipse (makePositive (r), p);
}

inline void SView::StrokeEllipse (BPoint center, float xRadius, float yRadius, pattern p)
{
	inherited::StrokeEllipse (center, xRadius, yRadius, p);
}

inline void SView::FillEllipse (BRect r, pattern p)
{
	inherited::FillEllipse (makePositive (r), p);
}

inline void SView::FillEllipse (BPoint center, float xRadius, float yRadius, pattern p)
{
	inherited::FillEllipse (center, xRadius, yRadius, p);
}

inline void SView::SStrokeRect (BRect r, pattern p)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SFillRect (BRect r, pattern p)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SInvertRect (BRect r)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SStrokeRoundRect (BRect r, float xRadius, float yRadius, pattern p)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SFillRoundRect (BRect r, float xRadius, float yRadius, pattern p)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SStrokeEllipse (BRect r, pattern p)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SStrokeEllipse (BPoint center, float xRadius, float yRadius, pattern p)
{
	center.x *= fScale;
	center.y *= fScale;
	xRadius *= fScale;
...
inline void SView::SFillEllipse (BRect r, pattern p)
{
	r.left *= fScale;
	r.top *= fScale;
	r.right *= fScale;
...
inline void SView::SFillEllipse (BPoint center, float xRadius, float yRadius, pattern p)
{
	center.x *= fScale;
	center.y *= fScale;
	xRadius *= fScale;
...
BRect SView::makePositive (BRect r)
{
	BRect res;
