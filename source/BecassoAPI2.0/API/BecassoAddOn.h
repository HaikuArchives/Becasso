...
#  define BLACK(x)    ((x) >> 24)
#  define PIXEL(r,g,b,a) (((int(b) << 24) & 0xFF000000) | ((int(g) << 16) & 0xFF0000) | ((int(r) << 8) & 0xFF00) | (int(a) & 0xFF))
#else	// IA
...
#  define YELLOW(x)  (((x) >> 16) & 0xFF)
#  define BLACK(x)    ((x) >> 24)
#  define PIXEL(r,g,b,a) (((int(a) << 24) & 0xFF000000) | ((int(r) << 16) & 0xFF0000) | ((int(g) << 8) & 0xFF00) | (int(b) & 0xFF))
#endif
...
extern "C" ADDON_EXPORT status_t process (Layer *inLayer, Selection *inSelection, Layer **outLayer, Selection **outSelection, int32 mode, BRect *frame, bool final, BPoint point, uint32 buttons);
// for Capture add-ons
...
IMPEXP void addon_update_statusbar (float delta, const char *text = NULL, const char *trailingText = NULL);
