...
const char *ToolSpecifiers[NumTools] = { "Brush", "Eraser", "Fill", "Text", "Spray Can", "Clone", "Freehand", "Lines", "Free Shape", "Polygons", "Rectangles", "Ovals", "Circles", "Ellipses" };
...
uchar cross[3][68] ={{ 16, // Size
						...
						0x03, 0x80, 0x03, 0x80, 0xFC, 0x7E, 0xFC, 0x7E,
						0xFC, 0x7E, 0x03, 0x80, 0x03, 0x80, 0x03, 0x80,
						0x03, 0x80, 0x03, 0x80, 0x03, 0x80, 0x00, 0x00 },
					  { 16,
					  	1,
					  	7, 7,
					  	0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x40,
					  	0x20, 0x40, 0x18, 0x80, 0x04, 0x00, 0x00, 0x00,
					  	0x00, 0x40, 0x02, 0x30, 0x04, 0x08, 0x04, 0x00,
					  	0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
					  	0x00, 0x00, 0x00, 0x70, 0x00, 0xF0, 0x70, 0xF0,
					  	0x7D, 0xE0, 0x7F, 0xE0, 0x3F, 0xC0, 0x0E, 0x70,
					  ...
					  { 16,
					  	...
					  	0x04, 0x08, 0x02, 0x30, 0x00, 0x40, 0x00, 0x00,
					  	0x04, 0x00, 0x18, 0x00, 0x40, 0x80, 0x00, 0x40,
					  	0x00, 0x40, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00,
					  	0x00, 0x00, 0x1C, 0x00, 0x1E, 0x00, 0x1E, 0x1C,
					  	0x0F, 0x7C, 0x0F, 0xFC, 0x07, 0xF8, 0x0E, 0xE0,
					  	0x3F, 0xC0, 0x7F, 0xE0, 0x7D, 0xE0, 0x70, 0xF0,
...
uchar ccross[68] = { 16, // Size,
					  ...
					  0x11, 0x10, 0x01, 0x00, 0x20, 0x08, 0x7C, 0x7C,
					  0x20, 0x08, 0x01, 0x00, 0x11, 0x10, 0x09, 0x20,
					  0x03, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
					  0x03, 0x80, 0x07, 0xC0, 0x0F, 0xE0, 0x1F, 0xF0,		// Mask
					  0x3B, 0xB8, 0x73, 0x9C, 0xFF, 0xFE, 0xFE, 0xFE,
					  0xFF, 0xFE, 0x73, 0x9C, 0x3B, 0xB8, 0x1F, 0xF0,
...
uchar scross[68] = { 16, // Size
					  ...
					  0x02, 0x80, 0x01, 0x00, 0x78, 0x3C, 0x44, 0x44,
					  0x78, 0x3C, 0x01, 0x00, 0x02, 0x80, 0x02, 0x80,
					  0x02, 0x80, 0x03, 0x80, 0x00, 0x00, 0x00, 0x00,
					  0x07, 0xC0, 0x07, 0xC0, 0x07, 0xC0, 0x07, 0xC0,	// Mask
					  0x07, 0xC0, 0xF8, 0x3E, 0xF8, 0x3E, 0xF8, 0x3E,
					  0xF8, 0x3E, 0xF8, 0x3E, 0x07, 0xC0, 0x07, 0xC0,
...
uchar picker[68] = { 16, // Size,
					 ...
					 14, 1, // hot spot
					  ...
					  0x01, 0xBC, 0x01, 0x38, 0x00, 0xE0, 0x01, 0x70,
					  0x02, 0xB0, 0x05, 0x00, 0x0A, 0x00, 0x14, 0x00,
					  0x28, 0x00, 0x50, 0x00, 0x60, 0x00, 0x00, 0x00,
					  0x00, 0x1E, 0x00, 0x3F, 0x00, 0x7F, 0x03, 0xFF,		// Mask
					  0x03, 0xFF, 0x03, 0xFE, 0x03, 0xFC, 0x07, 0xF8,
					  0x0F, 0xF8, 0x1F, 0xF8, 0x3F, 0x80, 0x7F, 0x00,
...
uchar mover[68]  = { 16,
					  ...
					  0x03, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
					  0x03, 0x80, 0x07, 0xC0, 0x07, 0xE0, 0x0F, 0xF0,
					  0x3F, 0xF8, 0x7B, 0xBC, 0xFF, 0xFE, 0xFF, 0xFE,
					  0xFF, 0xFE, 0x7B, 0xBC, 0x3F, 0xF8, 0x0F, 0xE0,
					  0x0F, 0xE0, 0x07, 0xC0, 0x03, 0x80, 0x00, 0x00 };

uchar rotator[68]= { 16,
					  1,
					  7, 7,
					  0x00, 0x00, 0x03, 0x80, 0x0C, 0x60, 0x10, 0x10,
					  0x20, 0x08, 0x20, 0x08, 0x41, 0x04, 0x42, 0x84,
					  0x41, 0x04, 0x20, 0x00, 0x20, 0x00, 0x10, 0xF0,
					  0x0C, 0x38, 0x03, 0xD0, 0x00, 0x10, 0x00, 0x00,
					  0x07, 0xC0, 0x1F, 0xF0, 0x3F, 0xF8, 0x7E, 0xFC,
					  0x78, 0x3C, 0xF3, 0x9E, 0xF7, 0xDE, 0xE7, 0xCE,
					  0xF7, 0xCE, 0xF3, 0x8E, 0x79, 0xF8, 0x7F, 0xF8,
...
//		printf ("Path now: %s\n", path.Path());
	...
	if (colordata)
	{
		...
		for (int i = 0; i < NumColors; i++)
		{
			...
			*ti++ = *cdata++;
			if (ShowColors)
				printf ("%3d %3d %3d %s\n", (int) RGBColors[i][0], (int) RGBColors[i][1], (int) RGBColors[i][2], &RGBColors[i][3]); 
		}
	}
	else
	...
	newnum = 1;
	refvalid = false;
	openPanel = new ThumbnailFilePanel (B_OPEN_PANEL, new BMessenger (this),
		NULL, B_FILE_NODE, false, new BMessage ('opnf'), NULL);
...
void Becasso::AboutRequested ()
{
//	char line[81];
//	sprintf (line, "Becasso v%s\n© 1997 ∑ Sum Software\nDemo version, expires 1 dec 1997\nhttp://www.sumware.demon.nl", Version);
//	BAlert *about = new BAlert ("", line, "OK");
//	about->Go();
	if (about && about->Lock())
	{
		about->Activate();
...
void Becasso::RefsReceived (BMessage *message)
{
...
void Becasso::ArgvReceived (int32 argc, char **argv)
{
...
status_t Becasso::GetSupportedSuites (BMessage *message)
{
...
BHandler *Becasso::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
//	printf ("message:\n");
//	message->PrintToStream();
//	printf ("\nspecifier:\n");
...
void Becasso::MessageReceived (BMessage *message)
{
...
//			system ("NetPositive http://www.sumware.demon.nl &");
		...
		case 'expt':
		{
			...
			{
				char errstring[256];
				sprintf (errstring, "There is no current ""scriptee"" window yet"); 
				if (message->IsSourceWaiting())
				{
					BMessage error (B_ERROR);
					error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
		...
		case 'newc':
		{
			...
			if (sizeWindow->Go())
			{
				...
				CanvasWindow *canvasWindow = new CanvasWindow (canvasWindowFrame, title, NULL, NULL, false, color);
			...
			if (message->FindRef ("ref", &ref) == B_NO_ERROR)
			{
				...
				if ((entry.SetTo (&ref, true) == B_NO_ERROR) && entry.IsFile())
				{
					...
					if ((s = node.ReadAttr ("BEOS:TYPE", B_STRING_TYPE, 0, buffer, 1022)) > 0)
					{
						...
						{
							BAlert *alert = new BAlert ("", lstring (6, "Please drop Becasso Palette files on the appropriate Color button or on the associated Color Editor window."), lstring (136, "OK"), NULL, NULL, B_WIDTH_AS_USUAL, B_WARNING_ALERT);
							alert->Go();
							break;
						}
					}
		...
		case CAPTURE_READY:
		{
			...
			if (message->FindInt32 ("index", &index) == B_OK)
			{
				...
				if (map)
				{
					if (map->IsValid())
					{
						...
						BRect canvasWindowFrame;
						canvasWindowFrame.Set (128 + newnum*16, 128 + newnum*16, 
							128 + newnum*16 + map->Bounds().Width(), 128 + newnum*16 + map->Bounds().Height());
						CanvasWindow *canvasWindow = new CanvasWindow (canvasWindowFrame, title, map);
						delete fCurrentScriptee;
						fCurrentScriptee = new BMessenger (canvasWindow);
						extern int SilentOperation;
			...
			{
				fprintf (stderr, "Error: Your capture add-on asked for a grab, but didn't identify itself.\n");
		...
		case B_SET_PROPERTY:
		{
			...
			case PROP_TOOL:
			{
				...
				if (message->FindString ("data", &namespecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Invalid Tool Name: ""%s""", namespecifier);
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
				...
				else if (message->FindInt32 ("data", &numberspecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Tool Index Out of Range [0..%ld]: %ld", NumTools - 1, numberspecifier); 
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
			...
			case PROP_MODE:
			{
				...
				if (message->FindString ("data", &namespecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Invalid Mode Name: ""%s""", namespecifier);
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
				...
				else if (message->FindInt32 ("data", &numberspecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Mode Index Out of Range [0..%ld]: %ld", NumTools - 1, numberspecifier); 
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
			...
			case PROP_FGCOLOR:
			{
				...
				if (message->FindString ("data", &namespecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Unknown Named Color: ""%s""", namespecifier);
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
			...
			case PROP_EXPFMT:
			{
				...
				else if (message->FindString ("data", &namedspecifier) == B_OK)
				{
					...
					for (int32 i=0; i < num_translators; i++)
					{
						...
						BTranslatorRoster::Default()->GetOutputFormats (translators[i], &fmts, &num_fmts); 
			...
			case PROP_SCRIPTEE:
			{
				...
				if (message->FindString ("data", &namespecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Invalid Scriptee: Couldn't find window named '%s'", namespecifier);
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
				...
				else if (message->FindInt32 ("data", &indexspecifier) == B_OK)
				{
					...
					{
						char errstring[256];
						sprintf (errstring, "Invalid Scriptee: Index %ld out of range [0..%ld]", indexspecifier, CountWindows() - 1);
						if (message->IsSourceWaiting())
						{
							BMessage error (B_ERROR);
							error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
				...
				{
					char errstring[256];
					sprintf (errstring, "Invalid Scriptee Type (either named (string) or indexed (int32) please)");
					if (message->IsSourceWaiting())
					{
						BMessage error (B_ERROR);
						error.AddInt32 ("error", B_BAD_SCRIPT_SYNTAX);
		...
		case B_GET_PROPERTY:
		{
			...
			case PROP_FGCOLOR:
			{
				...
				if (message->IsSourceWaiting())
				{
					...
					fprintf (stderr, "Current Foreground Color: [Red: %3d Green: %3d Blue: %3d Alpha: %3d]\n", rgb.red, rgb.green, rgb.blue, rgb.alpha);
				break;
			}
			case PROP_BGCOLOR:
			{
				...
				if (message->IsSourceWaiting())
				{
					...
					fprintf (stderr, "Current Background Color: [Red: %3d Green: %3d Blue: %3d Alpha: %3d]\n", rgb.red, rgb.green, rgb.blue, rgb.alpha);
				break;
			}
			case PROP_TABLET:
			{
				...
				if (wacom && wacom->IsValid())
				{
					...
					if (message->IsSourceWaiting())
					{
						...
						fprintf (stderr, "Current Tablet Area: [left: %5.0f top: %5.0f right: %5.0f bottom: %5.0f]\n", rect.left, rect.top, rect.right, rect.bottom);
				}
				else
				{
					char errstring[256];
...
void Becasso::setGrab (bool b, bool down)
{
...
void Becasso::setSelect ()
{
	SetCursor (scross);
	fCurrentCursor = CURSOR_SELECT;
}

void Becasso::setBusy ()
{
	fBusy = 1;
	fCurrentCursor = CURSOR_CROSS;
}

void Becasso::setReady ()
{
	fBusy = 0;
	extern PicMenuButton *mode;
	if (mode->selected() == M_SELECT)
...
void Becasso::FixCursor()	// BeOS bug w.r.t. hot spot of cursors
{
	BMessage fix('fixC');
