...
void GradientWindow::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case 'groL':
...
int addon_init (uint32 index, becasso_addon_info *info)
{
	...
	BRadioButton *oLinear = new BRadioButton (BRect (8, 13, 164, 30), "lin", "Linear", new BMessage ('groL'));
	BRadioButton *oCircular = new BRadioButton (BRect (8, 30, 164, 47), "circ", "Circular", new BMessage ('groC'));
	...
	BRadioButton *sLinear = new BRadioButton (BRect (8, 13, 164, 30), "slin", "Linear", new BMessage ('grsL'));
	BRadioButton *sCosine = new BRadioButton (BRect (8, 30, 164, 47), "scos", "Half Cosine", new BMessage ('grsS'));
	BRadioButton *sCircular = new BRadioButton (BRect (8, 47, 164, 64), "scirc", "Circle Arc", new BMessage ('grsC'));
