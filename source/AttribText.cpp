...
AttribText::AttribText() : AttribView(BRect(0, 0, 224, 208), lstring(25, "Text"))
{
	...
	AddChild(shSlid);
	AddChild(rtSlid);
	aaCheck = new BCheckBox(
		BRect(7, 109, 216, 127), "anti-aliasing", lstring(365, "Anti Aliasing"),
		new BMessage('fcAA')
	);
	aaCheck->SetValue(1);
	AddChild(aaCheck);
	...
	fText = new BTextView(
		BRect(8, 132, 216 - B_V_SCROLL_BAR_WIDTH, 202 - B_H_SCROLL_BAR_HEIGHT), "text",
		BRect(0, 0, 1024, 1), &fFont, 0, B_FOLLOW_NONE, B_WILL_DRAW
	);
