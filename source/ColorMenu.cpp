...
void ColorMenu::AddItem (ColorItem *item, BRect frame)
{
...
void ColorMenu::TearDone (BRect place, bool newwin)
{
	// printf ("CM::TearDone\n");
	if (newwin)
	{
...
void ColorMenu::Mark (int _index)
{
...
BPoint ColorMenu::ScreenLocation ()
{
	BScreen screen;
...
void ColorMenu::InvalidateWindow ()
{
	if (fWindow)
	{
		fWindow->Lock();
