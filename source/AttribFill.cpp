...
status_t AttribFill::GetSupportedSuites (BMessage *message)
{
...
BHandler *AttribFill::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
...
void AttribFill::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case B_GET_PROPERTY:
