...
public:
	...
	status_t Process(Layer* inLayer, Selection* inSelection, Layer** outLayer,
		Selection** outSelection, int32 mode = M_DRAW, BRect* frame = NULL, bool final = true,
...
private:
	...
	status_t (*process)(Layer* inLayer, Selection* inSelection, Layer** outLayer,
		Selection** outSelection, int32 mode, BRect* frame, bool final, BPoint point,
		uint32 buttons);
