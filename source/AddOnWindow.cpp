...
void
AddOnWindow::SetAddOn(becasso_addon_info* info)
{
	SetName(info->name);
	BMessage* msg = NULL;
	switch (info->type) {
...
void
AddOnWindow::UpdateStatusBar(float delta, const char* text, const char* trailingText)
{
...
void
AddOnWindow::ResetStatusBar(const char* label, const char* trailingLabel)
{
...
void
AddOnWindow::SetClient(BWindow* client)
{
