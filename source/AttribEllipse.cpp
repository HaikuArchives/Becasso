...
status_t AttribEllipse::GetSupportedSuites (BMessage *message)
{
...
BHandler *AttribEllipse::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
...
void AttribEllipse::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case B_GET_PROPERTY:
