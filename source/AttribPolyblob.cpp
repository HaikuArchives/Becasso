...
AttribPolyblob::AttribPolyblob() : AttribView(BRect(0, 0, 148, 90), lstring(29, "Free Shapes"))
{
	...
	BPoint pointArray[] = {BPoint(2, 8),   BPoint(3, 4),   BPoint(6, 3),   BPoint(9, 2),
						   BPoint(12, 3),  BPoint(20, 5),  BPoint(23, 7),  BPoint(27, 12),
						   BPoint(26, 15), BPoint(24, 20), BPoint(22, 23), BPoint(19, 28),
						   BPoint(18, 28), BPoint(16, 23), BPoint(15, 20), BPoint(13, 21),
						   BPoint(11, 23), BPoint(6, 22),  BPoint(4, 15),  BPoint(3, 10)};
