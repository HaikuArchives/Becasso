...
status_t AttribFreehand::GetSupportedSuites (BMessage *message)
{
...
BHandler *AttribFreehand::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
...
void AttribFreehand::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case B_GET_PROPERTY:
