...
void ColorMenuView::Draw (BRect /*updateRect*/)
{
	if (fCMB)
	{
...
void ColorMenuView::MouseDown (BPoint point)
{
	Window()->Lock();
...
BRect ColorMenuView::RectForIndex (int ind)
{
...
void ColorMenuView::MouseMoved (BPoint point, uint32 transit, const BMessage * /* msg */)
{
	int previndex = index;
