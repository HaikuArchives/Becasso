...
void
PatternMenuButton::editorSaysBye()
{
	editorshowing = false;
}

void
PatternMenuButton::ShowEditor()
{
...
void
PatternMenuButton::MouseDown(BPoint point)
{
	//	BMenuItem *selected;
	//	point = BPoint (0, 0);
...
void
PatternMenuButton::MessageReceived(BMessage* msg)
{
	inherited::MessageReceived(msg);
}

void
PatternMenuButton::MouseMoved(BPoint point, uint32 transit, const BMessage* msg)
{
	point = point;
	msg = msg;
...
void
PatternMenuButton::Draw(BRect update)
{
...
void
PatternMenuButton::set(int _index)
{
	if (_index >= P_SIZE)
		return;
...
void
PatternMenuButton::set(pattern _p)
{
	verbose(1, "PMB::set\n");
