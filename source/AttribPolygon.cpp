...
status_t AttribPolygon::GetSupportedSuites (BMessage *message)
{
...
BHandler *AttribPolygon::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
...
void AttribPolygon::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case B_GET_PROPERTY:
