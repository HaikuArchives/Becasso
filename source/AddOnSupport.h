...
extern "C" IMPEXP bgra_pixel average6(
	bgra_pixel a, bgra_pixel b, bgra_pixel c, bgra_pixel d, bgra_pixel e, bgra_pixel f);
extern "C" IMPEXP bgra_pixel average9(bgra_pixel a, bgra_pixel b, bgra_pixel c, bgra_pixel d,
	bgra_pixel e, bgra_pixel f, bgra_pixel g, bgra_pixel h, bgra_pixel i);
...
extern "C" IMPEXP void AddWithAlpha(
	BBitmap* src, BBitmap* dest, long x, long y, int strength = 255);
extern "C" IMPEXP void BlendWithAlpha(
	BBitmap* src, BBitmap* dest, long x, long y, int strength = 255);
extern "C" IMPEXP void CutOrCopy(
	BBitmap* src, BBitmap* dest, BBitmap* selection, long offx, long offy, bool cut);
