...
rgb_color
Brush::ToColor(int x, int y, rgb_color src, rgb_color dst)
{
...
BBitmap*
Brush::ToBitmap(rgb_color hi, rgb_color lo)
{
	if (!bitmap)
		bitmap = new BBitmap(BRect(0, 0, fWidth - 1, fHeight - 1), B_RGBA32);
