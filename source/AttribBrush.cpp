...
void AttribBrush::mkDiagonalBrush (Brush *b, int dir)
{
...
status_t AttribBrush::GetSupportedSuites (BMessage *message)
{
...
BHandler *AttribBrush::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
//	printf ("\nmessage:\n");
...
void AttribBrush::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case B_GET_PROPERTY:
