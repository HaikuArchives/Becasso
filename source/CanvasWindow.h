...
public:
			 CanvasWindow (BRect frame, const char *name, BBitmap *map = NULL, BMessenger *target = NULL, bool AskForAlpha = true, rgb_color color = White);
...
void		 restOfCtor (BRect frame, BBitmap *map, FILE *fp = NULL, bool AskForAlpha = true, rgb_color color = White);
