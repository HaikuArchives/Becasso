...
void		 ConstructCanvas (BBitmap *cvCanvas, BRect rect, bool doselect = true, bool do_export = false);
void		 Print ();
void		 Merge (BBitmap *a, Layer *b, BRect update, bool doselect = false, bool preserve_alpha = true);
