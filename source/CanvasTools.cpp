...
void
CanvasView::tClone(int32 mode, BPoint point, uint32 buttons)
{
...
void
CanvasView::tEraser(int32 mode, BPoint point, uint32 buttons)
{
	//	clock_t start, end;
...
void
CanvasView::tEraserM(int32 /* mode */, BPoint point)
{
	extern AttribEraser* tAttribEraser;
	int type = tAttribEraser->getType();
	float h = tAttribEraser->getYSize();
...
void
CanvasView::tText(int32 mode, BPoint point, uint32 buttons)
{
...
void
CanvasView::tTextM(int32 mode, BPoint point)
{
	extern AttribText* tAttribText;
...
void
CanvasView::tSpraycan(int32 mode, BPoint point, uint32 buttons)
{
	extern ColorMenuButton *locolor, *hicolor;
...
void
CanvasView::tSpraycanM(int32 mode, BPoint point, uint32 buttons, int pressure, BPoint /*tilt*/)
{
...
void
CanvasView::tFreehand(int32 mode, BPoint point, uint32 buttons)
...
void
CanvasView::tLines(int32 mode, BPoint point, uint32 buttons)
{
	extern PatternMenuButton* pat;
...
void
CanvasView::tLinesM(int32 mode, BPoint point)
{
...
void
CanvasView::tPolyblob(int32 mode, BPoint point, uint32 buttons)
{
	extern PatternMenuButton* pat;
...
void
CanvasView::tPolygon(int32 mode, BPoint point, uint32 buttons)
...
void
CanvasView::tPolygonM(int32 mode, BPoint point)
{
	if (entry && mouse_on_canvas) {
		extern AttribPolygon* tAttribPolygon;
		extern AttribDraw* mAttribDraw;
...
void
CanvasView::tRect(int32 mode, BPoint point, uint32 buttons)
{
	extern PatternMenuButton* pat;
...
void
CanvasView::tRectM(int32 mode, BPoint point)
{
	if (entry && mouse_on_canvas) {
		extern AttribRect* tAttribRect;
		extern PatternMenuButton* pat;
...
void
CanvasView::tRoundRect(int32 mode, BPoint point, uint32 buttons)
{
	extern PatternMenuButton* pat;
...
void
CanvasView::tRoundRectM(int32 mode, BPoint point)
{
	if (entry && mouse_on_canvas) {
		extern AttribRoundRect* tAttribRoundRect;
		extern PatternMenuButton* pat;
...
void
CanvasView::tCircle(int32 mode, BPoint point, uint32 buttons)
{
	extern PatternMenuButton* pat;
...
void
CanvasView::tCircleM(int32 mode, BPoint point)
{
	if (entry && mouse_on_canvas) {
		extern AttribCircle* tAttribCircle;
		extern PatternMenuButton* pat;
...
void
CanvasView::tEllipse(int32 mode, BPoint point, uint32 buttons)
{
	extern PatternMenuButton* pat;
...
void
CanvasView::tEllipseM(int32 mode, BPoint point)
{
	if (entry && mouse_on_canvas) {
		extern AttribEllipse* tAttribEllipse;
		extern PatternMenuButton* pat;
...
inline bool
CanvasView::inbounds(LPoint p)
{
	return (p.x >= 0 && p.x <= tw && p.y >= 0 && p.y <= th);
}

inline bool
CanvasView::isfillcolor0(LPoint point)
{
...
inline bool
CanvasView::isfillcolorrgb(LPoint point, uchar* t)
{
...
inline bool
CanvasView::istransparent8(LPoint point)
{
...
void
CanvasView::Fill(int32 mode, BPoint point, rgb_color* c)
{
	tFill(mode, point, B_PRIMARY_MOUSE_BUTTON, c);
}

void
CanvasView::tFill(int32 mode, BPoint point, uint32 buttons, rgb_color* c)
{
	extern Becasso* mainapp;
	extern ColorMenuButton *locolor, *hicolor;
	extern PatternMenuButton* pat;
	...
	// Change the following code some day to only iterate over BRect frame, since we have that
	// anyway. printf ("Adding alpha channel to temp bitmap\n");
	selection->Lock();
...
void
CanvasView::tSetColors(uint32 buttons)
{
	extern ColorMenuButton *hicolor, *locolor;
