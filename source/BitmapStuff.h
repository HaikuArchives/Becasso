...
void
InsertGlobalAlpha(Layer* layers[], int numLayers);
void
InvertWithInverseAlpha(BBitmap* src, BBitmap* selection);
void
AddToSelection(Brush* src, BBitmap* dest, long x, long y, int strength = 255);
void
...
gcd(int32 p, int32 q);
void
Rotate(SBitmap* s, Layer* d, BPoint origin, float rad, bool hiq);
void
Rotate(SBitmap* s, Selection* d, BPoint origin, float rad, bool hiq);
void
