...
status_t AttribPolyblob::GetSupportedSuites (BMessage *message)
{
...
BHandler *AttribPolyblob::ResolveSpecifier (BMessage *message, int32 index, BMessage *specifier, int32 command, const char *property)
{
...
void AttribPolyblob::MessageReceived (BMessage *msg)
{
	switch (msg->what)
	{
	case B_GET_PROPERTY:
